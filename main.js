...
.then(response => {
  if(response.media_type === "image"){
    ...
    document.querySelector("#displayImg").style.display = "block"
    .then.document.querySelector("img").src = response.hdurl;
    ...
    .then.document.querySelector("iframe").src = response.url;
  }
});
}
